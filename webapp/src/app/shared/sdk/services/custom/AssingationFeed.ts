...
/**
 * Api services for the `AssingationFeed` model.
 */
@Injectable()
export class AssingationFeedApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `AssingationFeed` object.)
   * </em>
   */
   ...
   *
   * @param {any} id AssingationFeed id
   *
   * @param {object} data Request data.
   *
  ...
  /**
   * Statistical information for AssingationFeed registers.
   *
