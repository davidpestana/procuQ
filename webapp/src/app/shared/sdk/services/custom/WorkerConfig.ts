...
/**
 * Api services for the `WorkerConfig` model.
 */
@Injectable()
export class WorkerConfigApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for WorkerConfig registers.
   *
