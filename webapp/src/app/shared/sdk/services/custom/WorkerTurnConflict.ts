...
/**
 * Api services for the `WorkerTurnConflict` model.
 */
@Injectable()
export class WorkerTurnConflictApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id WorkerTurnConflict id
   *
   ...
   * This usually means the response is a `WorkerTurnConflict` object.)
   * </em>
   */
  public getWorker(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WorkerTurnConflicts/:id/worker";
  ...
  /**
   * Fetches belongsTo relation turn.
   *
   * @param {any} id WorkerTurnConflict id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getTurn(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WorkerTurnConflicts/:id/turn";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation conflictWith.
   *
   * @param {any} id WorkerTurnConflict id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getConflictWith(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WorkerTurnConflicts/:id/conflictWith";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Statistical information for WorkerTurnConflict registers.
   *
